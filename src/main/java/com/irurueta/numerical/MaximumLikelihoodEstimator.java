...
public abstract class MaximumLikelihoodEstimator {
     ...
     *                         instance becomes unlocked.
     */
    public void setInputData(final double[] inputData) throws LockedException {
        if (isLocked()) {
            throw new LockedException();
        }
        this.inputData = inputData;
     ...
     *                                  negative or zero.
     */
    public static MaximumLikelihoodEstimator create(final double[] inputData) {
     ...
     * @throws IllegalArgumentException Exception raised if minValue &lt; maxValue.
     */
    private void internalSetMinMaxValues(final double minValue, final double maxValue) {
     ...
     *                                  sigma is negative or zero.
     */
    private void internalSetGaussianSigma(final double gaussianSigma) {
