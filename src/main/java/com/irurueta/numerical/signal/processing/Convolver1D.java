...
public class Convolver1D {
     ...
     *                                  have proper length.
     */
    public static void convolve(final double[] signal, final double[] kernel,
                                final double[] result) {
     ...
     */
    public static double[] convolve(final double[] signal, final double[] kernel,
                                    final int kernelCenter, final Convolver1DListener listener) {
     ...
     */
    public static void convolve(final double[] signal, final double[] kernel,
                                final int kernelCenter, final double[] result) {
     ...
     */
    public static double[] convolve(final double[] signal, final double[] kernel,
                                    final int kernelCenter, final ConvolverEdgeMethod edgeMethod) {
    ...
    public static double[] convolve(final double[] signal, final double[] kernel,
                                    final int kernelCenter, final ConvolverEdgeMethod edgeMethod,
                                    final double constantValue, final Convolver1DListener listener) {

        final double[] result = new double[signal.length + kernel.length - 1];
    ...
    public static void convolve(final double[] signal, final double[] kernel,
                                final int kernelCenter, final ConvolverEdgeMethod edgeMethod,
                                final double constantValue, final double[] result) {
        convolve(signal, kernel, kernelCenter, edgeMethod, constantValue,
                result, null);
    }
    ...
    private static void internalConvolveZero(
        ...
        for (int i = 0; i < resultLength; i++) {
            ...
            for (int j = 0; j < kernelLength; j++) {
                final double signalValue = getSignalValueZero(signal, signalPos - j);
            ...
            if (listener != null) {
                final float progress = (float) i / (float) resultLength;
    ...
    private static void internalConvolveConstant(
            final double[] signal, final double[] kernel, final int kernelCenter,
            final double constantValue, final double[] result, final Convolver1DListener listener) {
        final int kernelLength = kernel.length;
        final int resultLength = result.length;
        double accum;
        int signalPos;
        ...
        for (int i = 0; i < resultLength; i++) {
            ...
            signalPos = i - kernelCenter;
            for (int j = 0; j < kernelLength; j++) {
                final double signalValue = getSignalValueConstant(signal,
     ...
     * value otherwise.
     */
    protected static double getSignalValueConstant(final double[] signal, final int pos,
                                                   final double constantValue) {
        if (pos >= 0 && pos < signal.length) {
            return signal[pos];
        } else {
    ...
    private static void internalConvolveRepeat(
        ...
        for (int i = 0; i < resultLength; i++) {
            ...
            signalPos = i - kernelCenter;
            for (int j = 0; j < kernelLength; j++) {
                final double signalValue = getSignalValueRepeat(signal,
                        signalPos - j);
                accum += signalValue * kernel[j];
            }
    ...
    private static void internalConvolveMirror(
        ...
        for (int i = 0; i < resultLength; i++) {
            ...
            signalPos = i - kernelCenter;
            for (int j = 0; j < kernelLength; j++) {
                final double signalValue = getSignalValueMirror(signal,
                        signalPos - j);
                accum += signalValue * kernel[j];
            }
    ...
    protected static double getSignalValueMirror(double[] signal, int pos) {
        ...
        final boolean reversed = (times % 2 != 0);
