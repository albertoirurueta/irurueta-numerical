...
public class PROSACRobustEstimator<T> extends RobustEstimator<T> {
    ...
    public T estimate() throws LockedException, NotReadyException, 
        ...
        try {
            PROSACRobustEstimatorListener<T> listener = 
     ...
     * @return inliers data.
     */
    private static <T> int computeInliers(T iterResult, 
            double threshold, BitSet inliers, int totalSamples,
            PROSACRobustEstimatorListener<T> listener, double[] residuals) {
    ...
    public static class PROSACInliersData extends InliersData {
        ...
        public PROSACInliersData(int totalSamples, boolean keepInliers,
