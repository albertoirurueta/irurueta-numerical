...
public abstract class PolynomialEstimator {
     ...
     */
    public PolynomialEstimator(List<PolynomialEvaluation> evaluations) {
        this();
     ...
     */
    public PolynomialEstimator(PolynomialEstimatorListener listener) {
        this();
        mListener = listener;
    }
     ...
     */
    public void setListener(PolynomialEstimatorListener listener) 
            throws LockedException {
        if(isLocked()) {
            throw new LockedException();
        }
     ...
     */
    protected void fillDirectEvaluation(DirectPolynomialEvaluation evaluation, 
            Matrix a, Matrix b, int row) {
    ...
    protected void fillDerivativeEvaluation(
            DerivativePolynomialEvaluation evaluation, Matrix a, Matrix b, 
            int row) {
    ...
    protected void fillIntegralEvaluation(
            IntegralPolynomialEvaluation evaluation, 
            Matrix a, Matrix b, int row) throws PolynomialEstimationException {
    ...
    protected void fillIntegralIntervalEvaluation(
            IntegralIntervalPolynomialEvaluation evaluation, Matrix a, Matrix b,
            int row) throws PolynomialEstimationException {
