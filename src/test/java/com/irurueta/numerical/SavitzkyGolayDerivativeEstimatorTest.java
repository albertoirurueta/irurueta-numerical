...
class SavitzkyGolayDerivativeEstimatorTest implements SingleDimensionFunctionEvaluatorListener {
    ...
    void testConstructor() {
        ...
        final var estimator = new SavitzkyGolayDerivativeEstimator(this);
