...
class DirectionalDerivativeEvaluatorTest {
    ...
    void testConstructor() {
        ...
        final var evaluator = new DirectionalDerivativeEvaluator(listener, gradientListener, point, direction);
    ...
    @Test
    void testDifferentiateAt() throws Throwable {
        ...
        final var diff = evaluator.differentiateAt(x);
        ...
        final var gradient = new double[ndims];
