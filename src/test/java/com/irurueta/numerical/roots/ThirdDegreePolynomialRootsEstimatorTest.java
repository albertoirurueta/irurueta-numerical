...
public class ThirdDegreePolynomialRootsEstimatorTest {
    ...
    public void testConstructor() throws LockedException,
        ...
        final double[] polyParams = new double[4];
    ...
    public void testGetSetPolynomialParameters() throws LockedException,
        ...
        final double[] polyParams = new double[4];
        polyParams[3] = 1.0;
        final double[] polyParams2 = new double[5];
        polyParams2[3] = 1.0;
        polyParams2[4] = 0.0;
        final double[] badPolyParams = new double[3];
        final double[] badPolyParams2 = new double[4];
    ...
    private double[] generateThirdDegreePolynomialParams(final Complex root1,
