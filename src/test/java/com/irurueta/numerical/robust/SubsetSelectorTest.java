...
class SubsetSelectorTest {
    ...
    void testCreate() {
        ...
        final var selector = SubsetSelector.create(numSamples);
        assertEquals(SubsetSelector.DEFAULT_SUBSET_SELECTOR_TYPE, selector.getType());
        assertEquals(selector.getNumSamples(), numSamples);

        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> SubsetSelector.create(0));
    }
    ...
    void testGetSetNumSamples() {
        ...
        final var selector = SubsetSelector.create(numSamples1);
        // check correctness
    ...
    void testComputeRandomSubsets() throws NotEnoughSamplesException, InvalidSubsetSizeException {
        ...
        final var finalResult2 = result2;
        assertThrows(InvalidSubsetSizeException.class, () -> selector.computeRandomSubsets(0, finalResult2));
        ...
        final var result3 = new int[numSamples + 1];
        assertThrows(NotEnoughSamplesException.class, () -> selector.computeRandomSubsets(numSamples + 1,
                result3));
    }
    ...
    void testComputeRandomSubsetsInRange() throws NotEnoughSamplesException, InvalidSubsetSizeException,
        ...
        final int[] result2 = selector.computeRandomSubsetsInRange(minPos, maxPos, subsetSize, false);
        ...
        // Force InvalidSubsetSizeException
        assertThrows(InvalidSubsetSizeException.class, () -> selector.computeRandomSubsetsInRange(minPos, maxPos,
                0, false));
        assertThrows(InvalidSubsetSizeException.class, () -> selector.computeRandomSubsetsInRange(minPos, maxPos,
                0, false, result2));
        assertThrows(InvalidSubsetSizeException.class, () -> selector.computeRandomSubsetsInRange(minPos, maxPos,
                numSamples + 1, false, result2));
