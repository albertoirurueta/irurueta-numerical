...
public class PolynomialTest {
    ...
    public void testGetSetPolyParams() {
        ...
        Polynomial p = new Polynomial(polyParams);
    ...
    public void testMultiplyByScalarWithResult() {
        ...
        Polynomial p1 = new Polynomial(polyParams);
        
        double scalar = randomizer.nextDouble(MIN_RANDOM_VALUE, 
                MAX_RANDOM_VALUE);
        
        double[] result = ArrayUtils.multiplyByScalarAndReturnNew(polyParams, 
                scalar);
    ...
    public void testMultiplyByScalarAndReturnNew() {
        ...
        Polynomial p2 = p1.multiplyByScalarAndReturnNew(scalar);
    ...
    public void testGetRoots() throws NumericalException {
        ...
        for(int t = 0; t < TIMES; t++) {
            ...
            //test degree 1
            double root1 = randomizer.nextDouble(MIN_RANDOM_VALUE, 
                    MAX_RANDOM_VALUE);
            ...
            //test degree 2
            double root2 = randomizer.nextDouble(root1, 
                    root1 + MAX_RANDOM_VALUE);
            Polynomial p1 = new Polynomial(-root1, 1.0);
            Polynomial p2 = new Polynomial(-root2, 1.0);
            ...
            //test degree 3
            double root3 = randomizer.nextDouble(root2, 
            ...
            //test degree 4
            double root4 = randomizer.nextDouble(root3, 
                    root3 + MAX_RANDOM_VALUE);
            Polynomial p4 = new Polynomial(-root4, 1.0);
            p = p1.multiplyAndReturnNew(p2).multiplyAndReturnNew(p3).
            ...
            boolean cond1 = Math.abs(roots[0].getReal() - root1) <= LARGE_ABSOLUTE_ERROR ||
    ...
    public void testNthDerivativeWithResult() {
        ...
        Polynomial ddd2 = new Polynomial();
    ...
    public void testIntegrateInterval() {
        ...
        double startX = randomizer.nextDouble(MIN_RANDOM_VALUE, 
                MAX_RANDOM_VALUE);
        double endX = randomizer.nextDouble(startX, startX + MAX_RANDOM_VALUE);
    ...
    public void testTrim() {
        Polynomial p = new Polynomial(1.0, 2.0, 0.0);
    ...
    public void testGetMaxima() throws NumericalException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            //2nd degree
            double root2 = randomizer.nextDouble(root1, root1 + MAX_RANDOM_VALUE);
            Polynomial p2 = new Polynomial(-root2, 1.0);
            p = p1.multiplyAndReturnNew(p2);
            ...
            //4th degree
            double root3 = randomizer.nextDouble(root2, root2 + MAX_RANDOM_VALUE);
            Polynomial p3 = new Polynomial(-root3, 1.0);
