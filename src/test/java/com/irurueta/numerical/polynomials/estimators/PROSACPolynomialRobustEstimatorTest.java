...
public class PROSACPolynomialRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        // check correctness
        assertEquals(PROSACPolynomialRobustEstimator.DEFAULT_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new PROSACPolynomialRobustEstimator(wrongEvaluations);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        try {
            estimator = new PROSACPolynomialRobustEstimator(2, wrongEvaluations);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = null;
        try {
            estimator = new PROSACPolynomialRobustEstimator(wrongEvaluations, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
