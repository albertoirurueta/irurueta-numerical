...
class SimpsonDoubleExponentialRuleQuadratureMatrixIntegratorTest {
    ...
    @Test
    void constructor_makesNewInstance() throws WrongSizeException {
        ...
        final var integrator1 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener, EPS);

        assertNotNull(integrator1);

        final var integrator2 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener, EPS);

        assertNotNull(integrator2);

        final var integrator3 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener);

        assertNotNull(integrator3);

        final var integrator4 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener);

        assertNotNull(integrator4);

        final var listener2 = new DoubleExponentialMatrixSingleDimensionFunctionEvaluatorListener() {
            @Override
        ...
        final var integrator5 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener2, EPS);

        assertNotNull(integrator5);

        final var integrator6 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener2, EPS);

        assertNotNull(integrator6);

        final var integrator7 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener2);

        assertNotNull(integrator7);

        final var integrator8 = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener2);
    ...
    void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException, WrongSizeException {
        ...
        final var integrator = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener);
    ...
    @Test
    void integrate_whenImproperIntegrandWithSingularities_throwsIntegrationException() throws WrongSizeException {
        ...
        final var integrator = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY,
                listener);
    ...
    void getIntegratorType_returnsExpectedValue() throws WrongSizeException {
        ...
        final var integrator = new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(0.0, 1.0, listener);
