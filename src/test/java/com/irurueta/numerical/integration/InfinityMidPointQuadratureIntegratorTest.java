...
class InfinityMidPointQuadratureIntegratorTest {
    ...
    void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new InfinityMidPointQuadratureIntegrator(a, b, point -> NormalDist.p(point, mu, sigma));
    ...
    void getIntegratorType_returnsExpectedValue() {
        final var integrator = new InfinityMidPointQuadratureIntegrator(0.0, 1.0, null);
