...
class LowerSquareRootMidPointQuadratureTest {
    ...
    void next_returnsNotZeroValue() throws EvaluationException {
        ...
        final var quadrature = new LowerSquareRootMidPointQuadrature(a, b, polynomial::evaluate);
    ...
    void getType_returnsExpectedValue() {
        final var quadrature = new LowerSquareRootMidPointQuadrature(0.0, 1.0, null);
