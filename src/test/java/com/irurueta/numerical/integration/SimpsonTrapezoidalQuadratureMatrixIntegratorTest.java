...
class SimpsonTrapezoidalQuadratureMatrixIntegratorTest {
    ...
    void integrate_whenExponential1_returnsExpectedResult() throws WrongSizeException, IntegrationException {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureMatrixIntegrator(a, b, listener);
    ...
    void integrate_whenImproperIntegrandWithSingularities_throwsIntegrationException() throws WrongSizeException {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureMatrixIntegrator(0.0, 1.0, listener);
    ...
    @Test
    void integrate_whenImproperIntegralFromZeroToInfinity3_throwsIntegrationException() throws WrongSizeException {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY, listener);
