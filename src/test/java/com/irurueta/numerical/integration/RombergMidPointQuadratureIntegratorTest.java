...
class RombergMidPointQuadratureIntegratorTest {
    ...
    void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergMidPointQuadratureIntegrator(a, b, point -> NormalDist.p(point, mu, sigma));
    ...
    void integrate_whenExponential_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergMidPointQuadratureIntegrator(a, b, point -> Math.exp(lambda * point));
        final var result = integrator.integrate();
    ...
    void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergMidPointQuadratureIntegrator(0.0, 1.0,
    ...
    void integrate_whenImproperIntegralFromZeroToInfinity3_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergMidPointQuadratureIntegrator(0.0, ALMOST_INFINITY,
    ...
    void getIntegratorType_returnsExpectedValue() {
        final var integrator = new RombergMidPointQuadratureIntegrator(0.0, 1.0, null);
    ...
    private static void assertPolynomialIntegration(final int degree, final double error) throws IntegrationException {
        ...
        final var integrator = new RombergMidPointQuadratureIntegrator(a, b, polynomial::evaluate);
        final var result = integrator.integrate();
