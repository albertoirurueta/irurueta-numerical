...
class RombergLowerSquareRootMidPointQuadratureIntegratorTest {
    ...
    void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergLowerSquareRootMidPointQuadratureIntegrator(a, b,
    ...
    void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergLowerSquareRootMidPointQuadratureIntegrator(0.0, 1.0,
    ...
    void getIntegratorType_returnsExpectedValue() {
        final var integrator = new RombergLowerSquareRootMidPointQuadratureIntegrator(0.0, 1.0, null);
    ...
    private void assertPolynomialIntegration(final int degree, final double error) throws IntegrationException {
        ...
        final var integrator = new RombergLowerSquareRootMidPointQuadratureIntegrator(a, b, polynomial::evaluate);
        final var result = integrator.integrate();
