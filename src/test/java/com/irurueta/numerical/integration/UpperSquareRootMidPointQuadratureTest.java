...
class UpperSquareRootMidPointQuadratureTest {
    ...
    void next_returnsNotZeroValue() throws EvaluationException {
        ...
        final var b = randomizer.nextDouble(MIN_VALUE, MAX_VALUE);

        final var polynomial = buildPolynomial();

        final var quadrature = new UpperSquareRootMidPointQuadrature(a, b, polynomial::evaluate);
    ...
    void getType_returnsExpectedValue() {
        final var quadrature = new UpperSquareRootMidPointQuadrature(0.0, 1.0, null);
