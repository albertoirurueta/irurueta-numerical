...
class RombergTrapezoidalQuadratureMatrixIntegratorTest {
    ...
    void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException, WrongSizeException {
        ...
        final var integrator = new RombergTrapezoidalQuadratureMatrixIntegrator(a, b, listener);
    ...
    @Test
    void integrate_whenImproperIntegrandWithSingularities_returnsWrongResult() throws WrongSizeException {
        ...
        final var integrator = new RombergTrapezoidalQuadratureMatrixIntegrator(0.0, 1.0, listener);
    ...
    void integrate_whenImproperIntegralFromZeroToInfinity3_throwsIntegrationException() throws WrongSizeException {
        ...
        final var integrator = new RombergTrapezoidalQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY, listener);
