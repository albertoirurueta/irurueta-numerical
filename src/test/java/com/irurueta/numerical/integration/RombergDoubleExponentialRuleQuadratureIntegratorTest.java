...
class RombergDoubleExponentialRuleQuadratureIntegratorTest {
    ...
    void constructor_makesNewInstance() {
        ...
        final var interpolator1 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, HMAX, point -> 0, EPS);

        assertNotNull(interpolator1);

        final var interpolator2 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, point -> 0, EPS);

        assertNotNull(interpolator2);

        final var interpolator3 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, HMAX, point -> 0);

        assertNotNull(interpolator3);

        final var interpolator4 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, point -> 0);

        assertNotNull(interpolator4);

        final var interpolator5 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, HMAX,
                (point, delta) -> 0, EPS);

        assertNotNull(interpolator5);

        final var interpolator6 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, (point, delta) -> 0, EPS);

        assertNotNull(interpolator6);

        final var interpolator7 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, HMAX, (point, delta) -> 0);

        assertNotNull(interpolator7);

        final var interpolator8 = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, (point, delta) -> 0);
    ...
    void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b,
    ...
    void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergDoubleExponentialRuleQuadratureIntegrator(0.0, 1.0,
    ...
    void integrate_whenImproperIntegralFromZeroToInfinity3_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new RombergDoubleExponentialRuleQuadratureIntegrator(0.0, ALMOST_INFINITY,
    ...
    private static void assertPolynomialIntegration(final int degree, final double error) throws IntegrationException {
        ...
        final var integrator = new RombergDoubleExponentialRuleQuadratureIntegrator(a, b, polynomial::evaluate);
        final var result = integrator.integrate();
