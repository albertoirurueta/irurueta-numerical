...
class SimpsonTrapezoidalQuadratureIntegratorTest {
    ...
    void integrate_whenExponential_returnsExpectedResult() throws IntegrationException {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureIntegrator(a, b, point -> Math.exp(lambda * point));
    ...
    void integrate_whenImproperIntegrandWithSingularities_throwsIntegrationException() {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureIntegrator(0.0, 1.0,
    ...
    void integrate_whenImproperIntegralFromZeroToInfinity3_throwsIntegrationException() {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureIntegrator(0.0, ALMOST_INFINITY,
    ...
    void getIntegratorType_returnsExpectedValue() {
        final var integrator = new SimpsonTrapezoidalQuadratureIntegrator(0.0, 1.0, null);
    ...
    private static void assertPolynomialIntegration(final int degree, final double error) throws IntegrationException {
        ...
        final var integrator = new SimpsonTrapezoidalQuadratureIntegrator(a, b, polynomial::evaluate);
        final var result = integrator.integrate();
