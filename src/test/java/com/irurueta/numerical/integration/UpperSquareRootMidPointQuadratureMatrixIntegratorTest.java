...
class UpperSquareRootMidPointQuadratureMatrixIntegratorTest {
    ...
    void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult() throws IntegrationException,
        ...
        final var integrator = new UpperSquareRootMidPointQuadratureMatrixIntegrator(0.0, 1.0, listener);
