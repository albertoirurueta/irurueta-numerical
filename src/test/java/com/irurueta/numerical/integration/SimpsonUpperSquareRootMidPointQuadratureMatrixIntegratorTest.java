...
class SimpsonUpperSquareRootMidPointQuadratureMatrixIntegratorTest {
    ...
    void integrate_whenExponential2_returnsExpectedResult() throws WrongSizeException, IntegrationException {
        ...
        final var integrator = new SimpsonUpperSquareRootMidPointQuadratureMatrixIntegrator(a, b, listener,
    ...
    void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult() throws IntegrationException,
        ...
        final var integrator = new SimpsonUpperSquareRootMidPointQuadratureMatrixIntegrator(0.0, 1.0, listener);
